...
for($i = 0; $i < count($APJP_REMOTE_HTTP_SERVER_RESPONSE_PROPERTY_KEY); $i = $i + 1)
{
	if($APJP_REMOTE_HTTP_SERVER_RESPONSE_PROPERTY_KEY[$i] != '')
	{
		header($APJP_REMOTE_HTTP_SERVER_RESPONSE_PROPERTY_KEY[$i] . ': ' . $APJP_REMOTE_HTTP_SERVER_RESPONSE_PROPERTY_VALUE[$i]);
	}
}
